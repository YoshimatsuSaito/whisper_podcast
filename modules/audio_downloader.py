...
class AudioPathData:
    """Dataclass for the downloaded audio dir path"""
    enclosure: str
    audio_dir_path: Path
...
def download_and_chunk_audio(url: str, title: str, output_dir: Path, chunk_size: int = 10 * 60 * 1000):
    ...
    return AudioPathData(enclosure=url, audio_dir_path=chunk_dir)
